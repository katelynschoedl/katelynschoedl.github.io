...
\vspace{-0.5em}
\begin{zitemize}
    \item Wilderness First Responder (WFR) with AED and CPR Certification, Yosemite, CA (December 2025)
    \item AIARE 1 Avalanche Training Certification, Skyward Mountaineering - Silverton, CO (December 2025)
    \item Avalanche Companion Rescue Training, Alpine Ascents International x SheJumps - Snoqualmie, WA (January 2025)
\end{zitemize}
\columnbreak
